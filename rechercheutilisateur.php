                  ...
                  <div class='card shadow'>
                      ...
                      <div class='mb-9'>
                        <button class="b1" type=submit><img class="img1" src=image/picto-map-blanc.png height="50" width="50">  
                                ...
                                <!-------fin-->
                              <div class='mb-4'>
                                  <button class="b1" type=submit><img src=image/groupepicto.png height="50" width="50">  <div class="corpsformulaire">
                              ...
                              <div class="e">
                                ...
                                <input type="radio" name="wifi" class="wifi demoyes" id="wifi-a" checked
                                            value="false">
                                <label for="wifi-a"><img src='./image/wifipictorouge.png' width="60"
                                        alt='wifi interdiction' height="60" width="50"></label>
                                <input type="radio" name="wifi" class="wifi demono" id="wifi-b" value="true"
                                        class=form>
                                <label for="wifi-b"><img src="./image/wifipicto.png" width="60"
                                ...
                                <input type="radio" name="taxi" class="taxi demoyes" id="taxi-a" checked
                                    value="false">
                                <label for="taxi-a"><img src='./image/taxipictorouge.png' width="60"
                                alt='taxi interdiction' height="60" width="50"></label>
                                <input type="radio" name="taxi" class="taxi demono" id="taxi-b" value="true"
                                class=form>
                                <label for="taxi-b"><img src="./image/taxipicto.png" width="60"
                                alt="taxi autorisation" height="60" width="50"></label>
