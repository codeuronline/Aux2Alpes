...
<body>
    <div class="container">
        ...
        <div class="nom">
            <h1><?php echo $hebergement['nom']; ?><br></h1>

            <div class="disponible"><img src=image/calendrierpicto.png height="50"
                    width="50"><?php echo $hebergement['debut']; ?>/<?php echo $hebergement['fin']; ?></div>
            <div class="couchage"><img src=image/litpicto.png height="50" width="50">couchage:
                <?php echo $hebergement['couchage']; ?></div>
            <div class="prix"><?php echo $hebergement['prix']; ?><img src=image/europicto.png height="50" width="50">
            </div>
        </div>
